...
// itself - it just provides an interface by which other components can use.
...
// IsMigUnknownForInstance checks if MIG was marked as unknown for instance GceRef
...
// SetMigInstances assigns MIG ref to the instances refs
...
// MarkInstanceMigUnknown sets instance MIG to unknown
