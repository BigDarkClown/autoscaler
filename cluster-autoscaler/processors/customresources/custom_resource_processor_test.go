...
func TestFilterOutNodesWithUnreadyGpus(t *testing.T) {
	...
	processor := NewDefaultCustomResourceProcessor()
	newAllNodes, newReadyNodes := processor.FilterOutNodesWithUnreadyResource(&context.AutoscalingContext{}, gpu.ResourceNvidiaGPU, GPULabel, initialAllNodes, initialReadyNodes)
