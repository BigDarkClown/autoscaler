...
type AutoscalingProcessors struct {
	...
	CustomResourceProcessor customresources.CustomResourceProcessor
}
...
func DefaultProcessors() *AutoscalingProcessors {
	return &AutoscalingProcessors{
		...
		CustomResourceProcessor:    customresources.NewDefaultCustomResourceProcessor(),
	}
}
...
func (ap *AutoscalingProcessors) CleanUp() {
	...
	ap.CustomResourceProcessor.CleanUp()
}
